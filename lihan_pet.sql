...
CREATE TABLE `order`  (
  ...
  `appointment_time` datetime NULL DEFAULT NULL COMMENT '预约揽件时间',
  `pickup_time` datetime NULL DEFAULT NULL COMMENT '揽件时间',
  `shipping_code` tinyint NULL DEFAULT NULL COMMENT '寄件码',
  `send_address` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '寄件地址',
  `member_id` bigint NULL DEFAULT NULL COMMENT '寄件用户id',
  ...
  `transporter_id` bigint NULL DEFAULT NULL COMMENT '揽件人id',
  `createdon` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `createdby` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `modifiedon` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `modifiedby` bigint NULL DEFAULT NULL COMMENT '修改人id',
...
CREATE TABLE `pet`  (
  ...
  `pet_type` tinyint NULL DEFAULT NULL COMMENT '宠物类别',
  `pet_size` tinyint NULL DEFAULT NULL COMMENT '宠物体型',
  `pet_weight` float(3, 2) NULL DEFAULT NULL COMMENT '宠物体重',
  `medical_history` tinyint NULL DEFAULT NULL COMMENT '有无过往病史',
...
CREATE TABLE `place`  (
  `place_id` bigint NOT NULL AUTO_INCREMENT COMMENT '网点id',
  `place_name` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NULL DEFAULT NULL COMMENT '网点名称',
  `province_code` bigint NULL DEFAULT NULL COMMENT '所在省code',
  `city_code` bigint NULL DEFAULT NULL COMMENT '所在市code',
  `area_code` bigint NULL DEFAULT NULL COMMENT '所在区县code',
  `createdon` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `createdby` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `modifiedon` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `modifiedby` bigint NULL DEFAULT NULL COMMENT '修改人id',
...
CREATE TABLE `transporter`  (
  `transporter_id` bigint NOT NULL AUTO_INCREMENT COMMENT '运输员id',
  ...
  `palce_id` bigint NULL DEFAULT NULL COMMENT '负责网点id',
  `createdon` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `createdby` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `modifiedon` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `modifiedby` bigint NULL DEFAULT NULL COMMENT '修改人id',
...
CREATE TABLE `waybill`  (
  `waybill_id` bigint NOT NULL AUTO_INCREMENT COMMENT '运单id',
  ...
  `receiving_code` tinyint NULL DEFAULT NULL COMMENT '收件码',
  ...
  `waybill_type` tinyint NULL DEFAULT NULL COMMENT '运单运输方式',
  `waybill_status` tinyint NULL DEFAULT NULL COMMENT '运单状态',
  `transporter_id` bigint NULL DEFAULT NULL COMMENT '派件员id',
  `createdon` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `createdby` bigint NULL DEFAULT NULL COMMENT '创建人id',
  `modifiedon` datetime NULL DEFAULT NULL COMMENT '修改时间',
  `modifiedby` bigint NULL DEFAULT NULL COMMENT '修改人id',
...
CREATE TABLE `waybill_node`  (
  `waybill_node_id` bigint NOT NULL AUTO_INCREMENT COMMENT '运单节点id',
  `waybill_node_time` datetime NULL DEFAULT NULL COMMENT '运单节点时间',
  `waybill_node_status` tinyint NULL DEFAULT NULL COMMENT '节点运输状态',
  `transport_type` tinyint NULL DEFAULT NULL COMMENT '节点运输类型',
  ...
  `estimate_time` datetime NULL DEFAULT NULL COMMENT '预计到达时间',
  `createdon` datetime NULL DEFAULT NULL COMMENT '创建时间',
  `createdby` bigint NULL DEFAULT NULL COMMENT '创建人id',
